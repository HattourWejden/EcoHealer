import 'package:finalecohealer/home_screen.dart';
...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Widget _buildPasswordField() {
    return TextFormField(
      obscureText: true, // Pour afficher le mot de passe sous forme de points
      decoration: InputDecoration(
        labelText: 'Password',
        contentPadding: const EdgeInsets.only(top: 10.0, left: 10.0),
    ...
    return Container(
      child: Row(
        children: <Widget>[
          Theme(
            data: ThemeData(
                unselectedWidgetColor: Color.fromARGB(255, 255, 253, 253)),
            child: Checkbox(
              value: _rememberMe,
    ...
    return Container(
      ...
      child: ElevatedButton(
       ...
       onPressed: () {
        ...
        Navigator.of(context).push(MaterialPageRoute(
          builder: (context) => const HomeScreen(), // Utilisez votre nom de classe pour la page d'accueil
        ));
      },
